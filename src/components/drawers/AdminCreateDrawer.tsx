...
const AdminCreateDrawer: React.FC<AdminCreateDrawerProps> = ({
  ...
  const handleCreate = async () => {
    ...
    try {
        ...
        // Generic error
          ...
          errorMsg =
            typeof errorMessage === "string"
              ? errorMessage || "Error al crear el administrador. Por favor, intenta de nuevo."
              : Array.isArray(errorMessage)
      ...
      setErrorNotificationMessage(errorMsg || "Error al crear el administrador. Por favor, intenta de nuevo.");
