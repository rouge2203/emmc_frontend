...
export default function TeacherLayout() {
  ...
  const navItems = [
    { name: "Inicio", href: "/teacher/dashboard", icon: HomeIcon },
    { name: "Instrumentos", href: "/teacher/instrumentos", icon: PiPianoKeys },
  ];
  ...
  const isNavItemActive = (href: string) => {
    if (href === "/teacher/dashboard") {
      return (
        ...
        location.pathname.startsWith("/teacher/assignment") ||
        location.pathname.startsWith("/teacher/resource")
      );
    }
